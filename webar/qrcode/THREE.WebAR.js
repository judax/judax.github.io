...
THREE.WebAR.VRPointCloud = function(vrDisplay, usePointCloudVerticesDirectly) {
	...
	var positions = vrDisplay ? (usePointCloudVerticesDirectly ? vrDisplay.getPointCloud(true).vertices : new Float32Array( vrDisplay.getMaxPointCloudVertexCount() * 3 )) : new Float32Array([-1, 1, -2, 1, 1, -2, 1, -1, -2, -1, -1, -2 ]);
